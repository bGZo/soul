...
- ![1631073757234](../assets/mashibing/1631073757234.png)
...
- ![1631094038083](../assets/mashibing/1631094038083.png)
- 非统一内存访问架构的特点是：
...
- ![1631588534143](../assets/mashibing/1631588534143.png)
...
- ![1631589225439](../assets/mashibing/1631589225439.png)
- ### 3_删除CMS
- >  删除CMS垃圾回收器
...
- 关于ZGC的一些测试数据
- ![1631591809475](../assets/mashibing/1631591809475.png)
- ![1631592040352](../assets/mashibing/1631592040352.png)
...
- ![1631086461797](../assets/mashibing/1631086461797.png)
...
- ``` java
  ...
  */
  ...
  ```
- 如果没有友好提示
- ![1631087823799](../assets/mashibing/1631087823799.png)
- 如果有友好提示
- ![1631087848805](../assets/mashibing/1631087848805.png)
...
- ![1631670467582](../assets/mashibing/1631670467582.png)
- ![1631670520496](../assets/mashibing/1631670520496.png)
- 一个孵化器阶段,三个预览,两个废弃和两个移除
- JAVA15参与企业
- ![1631676405146](../assets/mashibing/1631676405146.png)
- > java各版本主要特征
...
- 各个本版JEP数量
- ![1631675941015](../assets/mashibing/1631675941015.png)
- idea 下载地址
...
- ![1631797518607](../assets/mashibing/1631797518607.png)
- Graal VM在hotSpot VM基础上,增强而形成的跨语言全栈虚拟机,可以作为"任何语言"的运行平台使用.
- # JAVA16
- ## 概述
- 2021年3月16日正式发布,一共更新了17JEP
- https://openjdk.java.net/projects/jdk/16/
- ![1631799306032](../assets/mashibing/1631799306032.png)
- ![1631801073728](../assets/mashibing/1631801073728.png)
- ## 一 语法层面
- ### 1_JEP 397：密封类（第二次预览）
- > sealed class 第二次预览
- 通过密封的类和接口来增强Java编程语言,这是新的预览特性,用于限制超类的使用密封的类和接口限制其他可继承或者实现他们的其他类或接口.
...
- ![1631802196015](../assets/mashibing/1631802196015.png)
- Java 17+ 可以免费使用了，包括商用，更详细的条款可以阅读：
- >  https://www.oracle.com/downloads/licenses/no-fee-license.html
- ![1631802323345](../assets/mashibing/1631802323345.png)
...
- ![1631802422250](../assets/mashibing/1631802422250.png)
- OpenJDK文档
- > https://openjdk.java.net/projects/jdk/17/
- ![1631802460848](../assets/mashibing/1631802460848.png)
